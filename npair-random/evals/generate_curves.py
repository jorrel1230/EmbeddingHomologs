...
h1 = plt.hist(npair_train_scores[npair_train_labels == 1], bins=100, color='blue', alpha=0.5, label='Positive Scores')
h2 = plt.hist(npair_train_scores[npair_train_labels == 0], bins=100, color='orange', alpha=0.5, label='Negative Scores')
plt.xlabel('Scores')
...
# Generate histogram of scores by label
plt.figure(figsize=(10, 6))
h1 = plt.hist(npair_test_scores[npair_test_labels == 1], bins=100, color='blue', alpha=0.5, label='Positive Scores')
h2 = plt.hist(npair_test_scores[npair_test_labels == 0], bins=100, color='orange', alpha=0.5, label='Negative Scores')
