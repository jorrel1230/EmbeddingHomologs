...
npair_train_embeddings = np.load("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_train_embeddings.npy")
npair_train_metadata = pd.read_csv("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_train_metadata.csv")

# Load the FAISS index
npair_train_index = faiss.read_index("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_train.index")

# Extract relevant columns for evaluation
npair_train_superfamilies = npair_train_metadata['sf'].values
npair_train_families = npair_train_metadata['fa'].values
npair_train_indices = npair_train_metadata.index.values

# ------------------------------------------------------------
# Loading Test Embeddings and Metadata
# ------------------------------------------------------------

npair_test_embeddings = np.load("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_test_embeddings.npy")
npair_test_metadata = pd.read_csv("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_test_metadata.csv")

# Load the FAISS index
npair_test_index = faiss.read_index("/scratch/gpfs/jr8867/main/db/indices/npair-random/npair-random_test.index")

# Extract relevant columns for evaluation
npair_test_superfamilies = npair_test_metadata['sf'].values
npair_test_families = npair_test_metadata['fa'].values
npair_test_indices = npair_test_metadata.index.values
...
if __name__ == "__main__":
    ...
    all_scores, all_labels = evaluate_similarity_search(
        npair_train_index, 
        npair_train_embeddings, 
        npair_train_superfamilies, 
        npair_train_families, 
        k=50
    )
    ...
    fpr, tpr, roc_auc = generate_roc_curve(
        all_scores, 
        all_labels, 
        output_path='/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_train_roc_curve.png'
    )
    
    print(f"ROC AUC: {roc_auc:.4f}")
    
    # Optionally, save scores and labels for future analysis
    np.save('/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_train_scores.npy', all_scores)
    np.save('/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_train_labels.npy', all_labels)
    ...
    all_scores, all_labels = evaluate_similarity_search(
        npair_test_index, 
        npair_test_embeddings, 
        npair_test_superfamilies, 
        npair_test_families, 
        k=50
    )
    ...
    fpr, tpr, roc_auc = generate_roc_curve(
        all_scores, 
        all_labels, 
        output_path='/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_test_roc_curve.png'
    )
    
    print(f"ROC AUC: {roc_auc:.4f}")
    
    # Optionally, save scores and labels for future analysis
    np.save('/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_test_scores.npy', all_scores)
    np.save('/scratch/gpfs/jr8867/main/db/indices/npair-random/evals/npair-random_test_labels.npy', all_labels)
