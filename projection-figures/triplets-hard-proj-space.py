...
model.load_state_dict(torch.load("/scratch/gpfs/jr8867/main/db/models/triplets-hard/triplets-hard-model-large.pth", map_location=device))
model.to(device)
...
plt.title(r'Triplet Loss w/ Hard Triplets: PCA Projection to $\mathbb{R}^2$', fontsize=14)
plt.xlabel('Principal Component 1', fontsize=12)
plt.ylabel('Principal Component 2', fontsize=12)
plt.grid()
plt.savefig('triplets-hard-proj-space.png')
plt.close()
