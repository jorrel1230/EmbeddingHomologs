...
triplets_train_embeddings = np.load("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_train_embeddings.npy")
triplets_train_metadata = pd.read_csv("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_train_metadata.csv")

# Load the FAISS index
triplets_train_index = faiss.read_index("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_train.index")
...
triplets_test_embeddings = np.load("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_test_embeddings.npy")
triplets_test_metadata = pd.read_csv("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_test_metadata.csv")

# Load the FAISS index
triplets_test_index = faiss.read_index("/scratch/gpfs/jr8867/main/db/indices/triplets-hard/triplets-hard_test.index")
...
if __name__ == "__main__":
    ...
    fpr, tpr, roc_auc = generate_roc_curve(
        all_scores, 
        all_labels, 
        output_path='/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_train_roc_curve.png'
    )
    
    print(f"ROC AUC: {roc_auc:.4f}")
    
    # Optionally, save scores and labels for future analysis
    np.save('/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_train_scores.npy', all_scores)
    np.save('/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_train_labels.npy', all_labels)
    ...
    fpr, tpr, roc_auc = generate_roc_curve(
        all_scores, 
        all_labels, 
        output_path='/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_test_roc_curve.png'
    )
    
    print(f"ROC AUC: {roc_auc:.4f}")
    
    # Optionally, save scores and labels for future analysis
    np.save('/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_test_scores.npy', all_scores)
    np.save('/scratch/gpfs/jr8867/main/db/indices/triplets-hard/evals/triplets-hard_test_labels.npy', all_labels)
