...
model.load_state_dict(torch.load("/scratch/gpfs/jr8867/main/db/models/triplets-random/triplets-random-model-large.pth"))
model.to(device)
...
faiss.write_index(index, "/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_train.index")

np.save("/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_train_embeddings.npy", train_projected_embeddings)
train_metadata.to_csv("/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_train_metadata.csv", index=False)

# Test Index
index = faiss.IndexFlatL2(test_projected_embeddings.shape[1])
index.add(test_projected_embeddings)
faiss.write_index(index, "/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_test.index")

np.save("/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_test_embeddings.npy", test_projected_embeddings)
test_metadata.to_csv("/scratch/gpfs/jr8867/main/db/indices/triplets-random/triplets-random_test_metadata.csv", index=False)
